...
public class TestFinance {
	...
	public void TestPV() {
		...
		//	I want to compare a double with a double... Doubles are not precice... I have to give a rounding factor.
	...
	public void TestPMT() {
		...
		int iYearsToWork2 = 10;
		double dAnnualReturnWorking2 = 0.05;
		int iYearsRetired2 = 5;
		double dAnnualReturnRetired2 = 0.03;
		double dRequiredIncome2 = 8000;
		double dMonthlySSI2 = 2641;

		double PV2 = Retirement.PV(dAnnualReturnRetired2 / 12, iYearsRetired2 * 12, dRequiredIncome2 - dMonthlySSI2, 0, false);
		double PMT2 = Retirement.PMT(dAnnualReturnWorking2 /12, 120, 0, PV2, false);
		
		assertEquals(1920.64, Math.abs(PMT2), 0.01);
	}
}
